		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Parceiros",
									"targetURL": "#zappparceiros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zappparceiros-display": {
								"semanticObject": "zappparceiros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zapp.parceiros",
									"url": sap.ui.require.toUrl("zapp/parceiros")
								}
							}
						}
					}
